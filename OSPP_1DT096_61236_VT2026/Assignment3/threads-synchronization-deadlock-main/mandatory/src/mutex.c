...
void *inc_no_sync(void *arg __attribute__((unused)))
{
    int i;
...
void *inc_tas_spinlock(void *arg __attribute__((unused)))
{
    int i;
...
void *dec_tas_spinlock(void *arg __attribute__((unused)))
{
    int i;
...
void *inc_atomic(void *arg __attribute__((unused)))
{
    int i;
...
void *dec_atomic(void *arg __attribute__((unused)))
{
    int i;
